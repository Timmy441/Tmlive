...
```text
https://your-deployed-domain.com/admin/index.html
```
...
Use the admin email and password created by `npm run seed-admin`, or paste the admin JWT token printed by that command into the token field.
